      ...
      <div className="w-full max-w-md rounded-lg border border-[#30363d] bg-[#161b22] p-8">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={isLoading}
            className="flex w-full items-center justify-center gap-3 rounded-md border border-[#30363d] bg-[#21262d] px-4 py-3 text-white transition-colors hover:bg-[#30363d] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
